...
const About = () => {
    return (
        <div className={styles.about}>
            <h1>Hi, I'm Shannon O'Hehir. A New York City-based software developer, tech enthusiast and podcaster.</h1>
            <img src={require("./images/about-me-new-compress.jpg")} alt="Shannon"/>
